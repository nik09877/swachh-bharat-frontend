    ...
    <Modal show={props.show} onHide={handleClose}>
      <Modal.Header closeButton>
        ...
        <p
          style={{ marginRight: '0' }}
          className={`badge ${
            pickupLocation.status == 'Cleaned' ? 'badge-success' : 'badge-error'
          }`}
        >
      ...
      <Modal.Body>
        ...
        <div className='modal__address'>
          ...
          <div className='row'>
            ...
            <div className='divider'>:</div>
            <div className='value'>
              {pickupLocation.dateCleaned ? pickupLocation.dateCleaned : 'N/A'}
            </div>
          </div>
      ...
      <div className='modal-footer'>
        <div
          ...
          className='model-footer__option'
        >
        ...
        <div
          ...
          className='model-footer__option red'
        >
          <div className='modal-footer__icon'>
